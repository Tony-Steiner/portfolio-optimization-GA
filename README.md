...
## 📉 The Problem: The "Passive" Bubble
...
Passive investors today are not buying "the market"—they are unknowingly making a massive, concentrated bet on the Tech sector. This introduces significant **idiosyncratic risk**; if the AI sector corrects, the entire "safe" index collapses.

## 🛡️ The Solution: Genetic Algorithm Optimization
...
* **Training Window:** 2006 – 2015 (Capturing the 2008 Financial Crisis).
* **Testing Window:** 2016 – Present (Strict Out-of-Sample).

### 1. The "Golden Age" (2016 – 2023)
...
### 2. The "Alpha Decay" Discovery (2024 – 2025)
...
* **Conclusion:** This validates the **"Alpha Decay" hypothesis**—quantitative models must be retrained periodically to adapt to new structural market realities.
...
```text
├── src/
│   ├── database_setup.py      # ETL Pipeline: Scrapes Banxico (CETES) & Yahoo Finance
│   ├── genetic_engine.py      # The Core AI: Genetic Algorithm Class
│   └── metrics_engine.py      # Financial Calculations (Sharpe, Volatility, CAGR)
│
├── notebooks/
│   ├── 1_Thesis_Validation.ipynb    # The "Honest" Backtest (2006-2025)
│   └── 2_Live_Portfolio.ipynb       # PRODUCTION: Generates this month's Buy List
│
...
* This notebook runs the Genetic Algorithm on current data (2015–Present).
